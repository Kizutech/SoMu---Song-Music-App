...
public class MusicPlayer2 extends AppCompatActivity {
    ...
    private String[] songTitles = {"Heart of Ice","IDGAF","Long Drives","Migraine","Prairies","She Said No","Sick of U","Toxic","Two Moons","Understand"};
    private int[] songResources = {R.raw.heartofice, R.raw.idgaf, R.raw.longdrives, R.raw.migraine, R.raw.prairies, R.raw.shesaidno, R.raw.sickofu, R.raw.toxic, R.raw.twomoons, R.raw.understand};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Music Player id
        songNameTextView = findViewById(R.id.textview102);
        playButton = findViewById(R.id.play_button2);
        nextButton = findViewById(R.id.next_button2);
        prevButton = findViewById(R.id.previous_button2);
        seekBar = findViewById(R.id.seek_bar2);
        timerTextView = findViewById(R.id.timerTextView2);

        //Music Player 10 Songs From Playlist
        Intent intent = getIntent();
        String songTitle = intent.getStringExtra("name2");

...
public class MusicPlayer1 extends AppCompatActivity {
    ...
    private String[] songTitles = {"Alone", "Fly", "Friends", "Happier", "Moving On", "Silence", "Spotlight", "Stars", "Summer", "Together"};
    private int[] songResources = {R.raw.alone1, R.raw.fly, R.raw.friends, R.raw.happier, R.raw.movingon, R.raw.silence, R.raw.spotlight, R.raw.stars, R.raw.summer, R.raw.together};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Music Player id
        songNameTextView = findViewById(R.id.textview101);
        playButton = findViewById(R.id.play_button1);
        nextButton = findViewById(R.id.next_button1);
        prevButton = findViewById(R.id.previous_button1);
        seekBar = findViewById(R.id.seek_bar1);
        timerTextView = findViewById(R.id.timerTextView1);

        //Music Player 10 Songs From Playlist
        Intent intent = getIntent();
        String songTitle = intent.getStringExtra("name1");
